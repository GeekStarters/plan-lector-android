...
public class MemoryActivity43 extends ActionBarActivity implements Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.memory43);
        setToolbar();
        iniciarCartas();
        imgBotones=new ImageView[]{img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12}; //arrglo de todos las cartas para poder utilizar
        desordenarCartas();
                ...
                try {
                    ...
                    else
                    {
                        ...
                        else //son diferente
                        {
                            ...
                            Thread hilo=new Thread(MemoryActivity43.this);
                            hilo.start(); //
