...
public class MyAccountParent extends Fragment implements View.OnClickListener {
    ...
    private void init() {
        ...
        final TextView parent_country = (TextView) context.findViewById(R.id.parent_country);
        final TextView parent_state = (TextView) context.findViewById(R.id.parent_state);
